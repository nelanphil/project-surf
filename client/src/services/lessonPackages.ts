export interface LessonPackage {
  ...
  goals: string[];
  highlights: string[];
  price: number; // Price as a number (e.g., 75 instead of '$75')
  image: string;
}
...
export const lessonPackages: LessonPackage[] = [
  {
    ...
    price: 75, // Changed from '$75' to 75
    image:
  ...
  //   ],
  //   price: 85, // Changed from '$85' to 85
  //   image:
...
export const getLessonPackageById = (id: number): LessonPackage | undefined => {
